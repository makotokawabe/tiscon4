CREATE TABLE PUBLIC.INSURANCE_ORDER (
  ...
  HOME_PHONE_NUMBER2 VARCHAR(13) NOT NULL,
  HOME_PHONE_NUMBER3 VARCHAR(13) NOT NULL,
...
COMMENT ON column PUBLIC.INSURANCE_ORDER.HOME_PHONE_NUMBER2 is '自宅電話番号2';
COMMENT ON column PUBLIC.INSURANCE_ORDER.HOME_PHONE_NUMBER3 is '自宅電話番号3';
