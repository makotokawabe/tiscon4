...
COMMENT ON column PUBLIC.INSURANCE_ORDER.DATE_OF_YEAR is '生まれ年';
COMMENT ON column PUBLIC.INSURANCE_ORDER.DATE_OF_MONTH is '生まれ月';
COMMENT ON column PUBLIC.INSURANCE_ORDER.DATE_OF_DATE is '生まれ日';
